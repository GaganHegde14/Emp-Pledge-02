    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full px-6 py-3">
        <div className="flex items-center gap-2 text-xs text-samsung-text">
          ...
          <span>
            My Workspace &gt; Diversity, Equity & Inclusion Module Training
            Video
          </span>
        </div>
      </div>
      ...
      <div className="w-full px-6">
        ...
        <div className="mb-6">
          <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex items-start gap-4">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center gap-4">
                    <div className="font-bold text-sm text-samsung-text">
                      Manoj Kandan M
                    </div>
                  ...
                  <div className="text-sm text-samsung-text">
                    Manoj.kandan@partner.samsung.com
                  </div>
                </div>
                <div className="w-1 h-14 bg-samsung-grey-light mx-4"></div>
                <div className="flex flex-col gap-1">
                  <div className="text-sm text-samsung-grey-600">
                    Designation
                  </div>
                  <div className="font-bold text-sm text-samsung-text">
                    Outsourcing
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="font-bold text-sm text-samsung-text">
                    Tech Strategy Team\Smart Infra Group\Information System & AI
                    Tools
                  </div>
                </div>
                <div className="w-1 h-14 bg-samsung-grey-light mx-4"></div>
            ...
            <div className="flex items-center gap-2">
              <svg
                className="w-8 h-8 text-samsung-color"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-samsung-grey-900">
        ...
        <div className="w-full mb-6">
          <div className="bg-samsung-blue-bg rounded-lg p-6 w-full">
            <h3 className="text-base font-bold text-samsung-text-primary mb-6">
              Self Essential Training Videos
            </h3>
            ...
            <div className="relative mb-8">
              ...
              <div className="inline-flex h-10 bg-samsung-toggle-bg rounded-full overflow-hidden">
                ...
                <button
                  onClick={() => setActiveTab("Privacy Training")}
                  className="text-sm font-medium text-samsung-text-primary px-4 py-2 whitespace-nowrap"
                >
                  Privacy Training
                </button>
                <button
                  onClick={() => setActiveTab("SRI-B POSH Training")}
                  className="text-sm font-medium text-samsung-text-primary px-4 py-2 whitespace-nowrap"
                >
                  SRI-B POSH Training
                </button>
            ...
            {/* White Title Text positioned below tabs */}
            <div className="mb-8">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <p className="text-sm text-black leading-relaxed">
                I have attended the online annual compliance training videos and
                hereby ensure compliance of the same
              </p>
            </div>
          </div>
        </div>
