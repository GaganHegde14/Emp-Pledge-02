    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full px-6">
        ...
        <div className="relative w-full">
          {/* Main blue background rectangle covering everything */}
          <div className="bg-samsung-blue-bg rounded-lg p-6 w-full">
            ...
            <div className="p-8 min-h-[400px] flex flex-col items-center justify-center mb-8">
            ...
            {/* Bottom section inside the blue rectangle */}
            <div className="bg-[#FBFCFC] rounded-lg p-6">
              {/* Compliance Checkbox */}
              <div className="flex items-start gap-4 mb-6">
                <button
